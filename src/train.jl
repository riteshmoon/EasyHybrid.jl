...
"""
function train(hybridModel, data; nepochs=200, batchsize=10, opt=Adam(0.01))
    ...
    return (; train_history, val_history, ŷ_train, αst_train, ŷ_val, αst_val, y_train, y_val, β_history)
end